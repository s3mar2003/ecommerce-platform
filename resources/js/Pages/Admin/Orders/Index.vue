    ...
    <div class="space-y-6">
      ...
      <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-1">إدارة جميع طلبات المتجر</p>
        </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
          ...
          <table class="w-full min-w-full">
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-4">
                  <!-- الحل: استبدال الرابط المفقود بزر -->
                  <button 
                    @click="showOrderDetails(order)" 
                    class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 transition-colors flex items-center gap-1"
                  >
        ...
        <div v-if="orders.data.length === 0" class="text-center py-12">
          ...
          <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">لم يتم العثور على طلبات تطابق بحثك</p>
        </div>
      </div>
